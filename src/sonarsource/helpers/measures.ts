...
function intFormatter(value: number | string): string {
...
function shortIntFormatter(value: number | string): string {
  if (typeof value !== 'number') {
    throw 'Unexpected type';
  }
...
function floatFormatter(value: number | string): string {
  if (typeof value !== 'number') {
    throw 'Unexpected type';
  }
...
function levelFormatter(value: string | number): string {
  ...
  const l10nKeys: { [type: string]: string } = {
    ERROR: 'Failed',
    WARN: 'Warning',
    OK: 'Passed',
    NONE: 'None'
...
function comparatorFormatter(value: string | number): string {
  if (typeof value !== 'string') {
    throw 'Unexpected type';
  }
...
function millisecondsFormatter(value: number | string): string {
  if (typeof value !== 'number') {
    throw 'Unexpected type';
  }
